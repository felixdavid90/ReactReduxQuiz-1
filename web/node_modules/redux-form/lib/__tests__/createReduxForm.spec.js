...
describe('createReduxForm', function () {
  ...
  it('should NOT call async validation if form is pristine and initialized', function () {
    ...
    var asyncValidate = _expect.createSpy().andReturn(Promise.reject(errorValue));
    var Decorated = reduxForm({
      form: form,
      fields: ['foo', 'bar'],
  ...
  it('should call async validation if form is dirty and initialized', function () {
    ...
    _expect2['default'](asyncValidate).toHaveBeenCalled();
  });
  ...
  it('should add array values with defaults', function () {
    ...
    _expect2['default'](after).toNotBe(before); // should be a new instance
  ...
  it('should add array values when root is not an array', function () {
    ...
    _expect2['default'](stub.props.fields.acknowledgements).toBeA('object');
    _expect2['default'](stub.props.fields.acknowledgements.items).toBeA('array');
    _expect2['default'](stub.props.fields.acknowledgements.items.length).toBe(0);
    _expect2['default'](stub.props.fields.acknowledgements.items.addField).toBeA('function');
    ...
    // check field
    _expect2['default'](stub.props.fields.acknowledgements.items.length).toBe(1);
    _expect2['default'](stub.props.fields.acknowledgements.items[0]).toBeA('object');
    expectField({
  ...
  it('should add array values with DEEP defaults', function () {
    ...
    _expect2['default'](stub.props.fields.proposals).toBeA('array');
    _expect2['default'](stub.props.fields.proposals.length).toBe(0);
    _expect2['default'](stub.props.fields.proposals.addField).toBeA('function');
    ...
    // check field
    _expect2['default'](stub.props.fields.proposals.length).toBe(1);
    _expect2['default'](stub.props.fields.proposals[0]).toBeA('object');
    expectField({
  ...
  it('should only change the deep field that changed', function () {
    ...
    _expect2['default'](stub.props.fields.address).toNotBe(address);
    _expect2['default'](stub.props.fields.address.street).toBe(street);
    _expect2['default'](stub.props.fields.address.postalCode).toNotBe(postalCode);
  });
  ...
  it('should change field tree up to array that changed', function () {
    ...
    _expect2['default'](stub.props.fields.contact.shipping.phones).toNotBe(shippingPhones);
    _expect2['default'](stub.props.fields.contact.shipping).toNotBe(shipping);
    _expect2['default'](stub.props.fields.contact).toNotBe(contact);
    _expect2['default'](stub.props.fields.contact.billing).toBe(billing);
    _expect2['default'](stub.props.fields.contact.billing.phones).toBe(billingPhones);
    ...
    _expect2['default'](stub.props.fields.contact.shipping.phones[0]).toNotBe(shippingPhones0);
    _expect2['default'](stub.props.fields.contact.shipping.phones).toNotBe(shippingPhones);
    _expect2['default'](stub.props.fields.contact.shipping).toNotBe(shipping);
    _expect2['default'](stub.props.fields.contact).toNotBe(contact);
    _expect2['default'](stub.props.fields.contact.billing).toBe(billing);
  ...
  it('should provide a submit() method to submit the form', function () {
    ...
    var onSubmit = _expect.createSpy().andReturn(Promise.resolve());
    var Decorated = reduxForm({
      form: form,
    ...
    _expect2['default'](onSubmit).toNotHaveBeenCalled();

    _reactAddonsTestUtils2['default'].Simulate.click(button);

    _expect2['default'](onSubmit).toHaveBeenCalled().toHaveBeenCalledWith(initialValues, store.dispatch);
  });
  ...
  it('submitting from parent should fail if sync validation errors', function () {
    ...
    var initialValues = { firstName: 'Bobby', lastName: 'Tables', age: 12 };
    var onSubmit = _expect.createSpy().andReturn(Promise.resolve());
    var validate = _expect.createSpy().andReturn({ firstName: 'Go to your room, Bobby.' });
    var Decorated = reduxForm({
      form: form,
      fields: ['firstName', 'lastName', 'age'],
      initialValues: initialValues,
    ...
    _expect2['default'](validate).toHaveBeenCalled();
    _expect2['default'](onSubmit).toNotHaveBeenCalled();
  });
